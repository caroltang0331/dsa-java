...
public class TrieQuizTest {
    ...
    public void testGetEntities() {
        final List<String> L = List.of("United States", "South Korea", "United States of America", "South Kore");
        ...
        List<Entity> entities = List.of(new Entity(14,24,3), new Entity(44,68,2),new Entity(44, 57, 0), new Entity(14, 25, 1));

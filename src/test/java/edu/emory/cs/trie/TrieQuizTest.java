...
public class TrieQuizTest {
    ...
    public void testGetEntities() {
        final List<String> L = List.of("United States", "South Korea", "United States of America", "outh Kore");
        TrieQuiz trie = new TrieQuiz();
        for (int i = 0; i < L.size(); i++)
            trie.put(L.get(i), i);

        String input = "I was born in South Korea and raised in the United States of America.";
        List<Entity> entities = List.of(new Entity(15,24,3), new Entity(44,68,2),new Entity(44, 57, 0), new Entity(14, 25, 1));

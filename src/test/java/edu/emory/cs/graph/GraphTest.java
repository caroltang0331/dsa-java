...
import edu.emory.cs.graph.span.*;
...
public class GraphTest {
    ...
    public void GraphQuiz() {
        GraphQuiz graph0 = new GraphQuiz(3);
...
//        GraphQuiz graph6 = new GraphQuiz(6);
        graph0.setUndirectedEdge(0,1,1);
        graph0.setUndirectedEdge(0,2,1);
        graph0.setUndirectedEdge(2,1,2);
        MST test = new Kruskal1();
        System.out.println("tree " + test.getMinimumSpanningTree(graph0));
//
//
//Test0#1
